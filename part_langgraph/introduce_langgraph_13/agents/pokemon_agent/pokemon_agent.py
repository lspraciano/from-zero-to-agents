...
from part_langgraph.introduce_langgraph_13.agents.pokemon_agent.pokemon_agent_template import pokemon_agent_template
...
def pokemon_agent(state: State) -> Command:
    ...
    pokemon_response: PokemonAgentResponseFormat = pokemon_result[
        "structured_response"
    ]
